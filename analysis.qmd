...
The job market in the United States has become increasingly competitive in recent years. Various economic, social, and technological factors contribute to this complexity, ranging from automation and globalization to shifts in labor demand across industries. 

To better understand the underlying causes of this phenomenon, an analysis of employment trends in the U.S need to be conducted, using data from the United States Census Bureau and the National Center for Science and Engineering Statistics (NCSES). Specifically, the analysis focus on employment patterns between 2017 and 2021 to identify the factors influencing job availability and workforce participation. This study aims to shed light on the relationship between race, types of employment, income and employment, and how they collectively shape the U.S. labor market.
...
Revenue could influence income by enabling higher wages and job growth. We aim to analyze at which stage revenue has the greatest impact and the reasons behind this.
...
```
In this bar chart, male employment significantly exceeds female employment, especially for the industries like: construction, transportation and warehousing, and manufacturing. These industries traditionally employ a higher percentage of males due to the nature of the work like manual labor.
The dominance in the female employment industry are health care and social assistance, administrative and support services, which are often aligned with traditional roles associated with women.
...
In the analysis, we may not find the causation and correlation. For example, in our third theme, we analyze the relationship between revenue and income. This observation may not imply causation. External factors such as market conditions, industry regulations, or economic trends could influence both revenue and income. 
