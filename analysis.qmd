...
The job market in the United States has become increasingly competitive in recent years. Various economic, social, and technological 
factors contribute to this complexity, ranging from automation and globalization to shifts in labor demand across industries. 

To better understand the underlying causes of this phenomenon, an analysis of employment trends in the U.S need to be conducted, using data from the United 
States Census Bureau and the National Center for Science and Engineering Statistics (NCSES). Specifically, the analysis focus on employment patterns between 2017 
and 2021 to identify the factors influencing job availability and workforce participation. This study aims to shed light on the relationship between race, types 
of employment, income and employment, and how they collectively shape the U.S. labor market.
...
newer firms across all categories. The year 2019 saw a sharp income spike, particularly for younger firms. We can infer the potential reason that policies such 
as Small Business Administration (SBA) loans, streamlined regulatory processes, increased federal procurement opportunities, and entrepreneurship promotion 
...
In the analysis, we may not find the causation and correlation. For example, in our third theme, we analyze the relationship between revenue and income. This 
observation may not imply causation. External factors such as market conditions, industry regulations, or economic trends could influence both revenue and 
income. 
