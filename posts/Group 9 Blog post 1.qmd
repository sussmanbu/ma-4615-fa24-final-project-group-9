...
The questions we hope to address when using this data set are:
1. What time of year are most crimes reported?
2. What race, age group, and sex most frequently shows up as the perpetrator
3. Which precinct collects the most arrests?
4. Are there certain crimes that each gender does more frequently?
